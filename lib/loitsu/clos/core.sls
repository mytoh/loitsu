...
(library (loitsu clos core)
  ...
  (import (only (loitsu clos bootstrap standard-classes) <method> <generic> <entity-class> <procedure-class>
                <object> <top> <class>)
          (only (loitsu clos bootstrap generic-functions) print-object compute-apply-methods compute-method-more-specific?
